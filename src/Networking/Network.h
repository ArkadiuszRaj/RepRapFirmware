...
#if (__LPC17xx__ || __STM32__) && (HAS_WIFI_NETWORKING == 0) && (HAS_RTOSPLUSTCP_NETWORKING == 0)
# include "NoNetwork/Network.h"
#else
#if defined(DUET3_V03)
const size_t NumNetworkInterfaces = 2;
#elif defined(DUET3_V06) || defined(DUET_NG) || defined(DUET_M) || defined(__LPC17xx__) || defined(__STM32__) || defined(PCCB) || defined(DUET3MINI)
