...
#if !defined(DEBUG) && !defined(__LPC17xx__) && !defined(__STM32__)	// don't check the CRC of a debug build because debugger breakpoints mess up the CRC
...
#if !__LPC17xx__ && !SAME5x && !__STM32__
